...
public class StrongPlayer implements Player {
    private int health;
    private static final int HEALTH_DECREMENT = 12;
    private static final int SHOTS_PER_TURN = 4;
    private int shotsThisTurn;
    private Gun myGun;
    private boolean isActive;
    private boolean hasMoved;

    public StrongPlayer(int initialShotsThisTurn, boolean isActive, boolean hasMoved, int initialX, int initialY, int initialRadius,
    ...
    public void shrinkGun(int initialBarrelLength, int initialRadius){
        // reduce health by 10% - nine lives in the game per player
